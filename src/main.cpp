#include "../include/glad-glad2/glad.h"
...
int main()
{
	...
	/************************************ TEXTURES ************************************/
	unsigned int diffuseMap = loadTexture(TEXTURE_DIR "container2.png");
	unsigned int specularMap = loadTexture(TEXTURE_DIR "container2_specular.png");

	/************************************ SHADERS ************************************/
	Shader lightingShader(SHADER_DIR "shader.vs", SHADER_DIR "shader.fs");
	Shader lightCubeShader(SHADER_DIR "lightCube.vs", SHADER_DIR "lightCube.fs");
...
unsigned int loadTexture(const char* path)
{
	...
	if (data) {
		/* See which color format the texture uses */
		GLenum format;
		if (nrComponents == 1)
			format = GL_RED;
